          ...
          <div v-else-if="envSetupState === 'unlocked'" class="bg-white border border-emerald-200 p-5 rounded-sm relative shadow-sm">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <input v-model="envData.ENTRA_CLIENT_SECRET" :type="showEntraSecret ? 'text' : 'password'" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" class="w-full border border-slate-300 rounded-sm pl-3 pr-10 py-2 text-[12px] focus:border-slate-800 outline-none font-mono"/>
