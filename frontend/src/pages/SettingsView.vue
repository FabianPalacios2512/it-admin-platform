      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          ...
          <div class="col-span-1 relative">
            ...
            <div class="relative">
              <input v-model="config.LDAP_PASSWORD" :type="showPassword.LDAP_PASSWORD ? 'text' : 'password'" class="w-full pl-3 pr-10 py-2 bg-white border border-gray-200 rounded text-[13px] text-gray-900 focus:outline-none focus:border-gray-400 focus:ring-0 placeholder-gray-400 transition-colors" placeholder="••••••••">
          ...
          <div class="col-span-1 relative">
            ...
            <div class="relative">
              <input v-model="config.SECRET_KEY" :type="showPassword.SECRET_KEY ? 'text' : 'password'" class="w-full pl-3 pr-10 py-2 bg-white border border-gray-200 rounded text-[13px] text-gray-900 focus:outline-none focus:border-gray-400 focus:ring-0 placeholder-gray-400 transition-colors" placeholder="••••••••">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          ...
          <div class="col-span-2 relative">
            ...
            <div class="relative">
              <input v-model="config.ENTRA_CLIENT_SECRET" :type="showPassword.ENTRA_CLIENT_SECRET ? 'text' : 'password'" class="w-full pl-3 pr-10 py-2 bg-white border border-gray-200 rounded text-[13px] text-gray-900 focus:outline-none focus:border-gray-400 focus:ring-0 placeholder-gray-400 transition-colors font-mono" placeholder="••••••••">
